// get node packages
const debug = require('debug')('offline-geo-from-ip:main')
const path = require('path')
const mmdbreader = require('maxmind-db-reader')

const city = mmdbreader.openSync(
  path.resolve(path.join(__dirname, '/../database/geolite2-city.mmdb'))
)

debug(`offline-geo-from-ip ready for action!`)
